package uk.gov.hmcts.reform.demo.fis.event.model;
...
import static uk.gov.hmcts.reform.demo.fis.event.model.UserRole.CASE_WORKER;
import static uk.gov.hmcts.reform.demo.fis.event.model.UserRole.CITIZEN;
import static uk.gov.hmcts.reform.demo.fis.event.model.UserRole.COURT_ADMIN;
import static uk.gov.hmcts.reform.demo.fis.event.model.UserRole.CREATOR;
import static uk.gov.hmcts.reform.demo.fis.event.model.UserRole.DISTRICT_JUDGE;
import static uk.gov.hmcts.reform.demo.fis.event.model.UserRole.LEGAL_ADVISOR;
import static uk.gov.hmcts.reform.demo.fis.event.model.UserRole.SOLICITOR;
